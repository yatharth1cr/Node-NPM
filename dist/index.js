...
})(
  {
    ...
    "index.js": [
      function (require, module, exports) {
        ...
        var d = moment("2020-01-01", "YYYY-MM-DD").isValid();
        console.log(d); //true

        var e = moment("2020-14-01", "YYYY-MM-DD").isValid();
        console.log(e); //false

        // 3. Manipulating Dates

        // adds 7 days to current date
        var f = moment().add(7, "days").format("DD");
        console.log(f); //13

        // adds 7 months to current date
        var g = moment().add(7, "months").format("MM");
        console.log(g); //11

        // adds 7 years to current date
        var h = moment().add(7, "years").format("YYYY");
        console.log(h); //2031

        // subtracts 7 days to current date
        var i = moment().subtract(7, "days").format("DD");
        console.log(i); //30

        // subtracts 7 months to current date
        var j = moment().subtract(7, "months").format("DD");
        console.log(j); //06

        // subtracts 7 years to current date
        var k = moment().subtract(7, "years").format("DD");
        console.log(k); //06
        ...
        var after1 = moment("2020-01-01").isAfter("2018-01-01");
        console.log(after1);
        // Check is 2010-01-01 date after 2018-01-01
        var after2 = moment("2010-01-01").isAfter("2018-01-01");
        console.log(after2);
        // Check if the year 2019 is a leap year
        var leap1 = moment("2019").isLeapYear();
        console.log(leap1);
        // Check if the year 2020 is a leap year
        var leap2 = moment("2020").isLeapYear();
        console.log(leap2);
      },
